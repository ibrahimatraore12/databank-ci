...
from components.ui import (  # noqa: E402
    afficher_entete, afficher_selecteur_langue, format_fcfa, label_technique, requete_duckdb, t,
)
...
col1.metric(t("cible_cross_sell"), int(df["is_cross_sell_target"].sum()))
col2.metric(t("opportunite_upsell_salaire"), int(df["is_salary_upsell_opportunity"].sum()))
